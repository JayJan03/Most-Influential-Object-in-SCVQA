...
def evaluate(model, dataloader):
    ...
    pickle.dump(loss_hint, open('loss_hint_vqx.pkl', 'wb'))
    pickle.dump(loss_hint_ind, open('loss_hint_ind_vqx.pkl', 'wb'))
    pickle.dump(logits, open('logits_vqx.pkl', 'wb'))
    pickle.dump(prob, open('prob_vqx.pkl', 'wb'))
