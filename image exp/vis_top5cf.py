...
att_data = []
with open('/home/cvpr/jayant/scvqa/att_gv_100_cf.pkl', 'rb') as fr:
    try:
        while True:
...
#att_data_orig = att_data_orig[0][0].cpu().detach().numpy()
...
ff1 = open("/home/cvpr/jayant/scvqa/vis_img/top5_100.pkl", "rb")
