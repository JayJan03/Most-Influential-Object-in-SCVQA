...
from dataset import Dictionary, SelfCriticalDataset1	#100 entries

from models import Model
import utils
import opts
from train_bb import train				#train_bb
...
if __name__ == '__main__':
    ...
    train_dset = SelfCriticalDataset1(opt.split, dictionary, opt)
    train_loader = DataLoader(train_dset, opt.batch_size, shuffle=True, num_workers=0)
    opt.use_all = 1
    eval_dset = SelfCriticalDataset1(opt.split_test, dictionary, opt)
