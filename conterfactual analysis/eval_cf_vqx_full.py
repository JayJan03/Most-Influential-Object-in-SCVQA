...
def evaluate(model, dataloader):
    ...
    for objs, q, a, hintscore, _, qids in tqdm(iter(dataloader)):
        ...
        #listbb = att100[0][2].tolist()						#not req cause not using object detector here
        ...
        #for i in range(len(listind)):
         ...
         #   dictt.append(listind[i])




        #print("objs_original:::::",objs)
        ...
        for jj in range(len(objs)):
            ...
            for ll in range(num_mio):
                for kk in range(2048):
                    ...
                    objs[jj][listind[jj][ll]][kk] = np.random.rand(1)		#counterfactual
