...
ff3 = open("/home/cvpr/jayant/scvqa/vis_img/qid2top5_vqx_train.pkl", "rb")		# this file is of same format as for top5 file above 
u3 = pickle._Unpickler( ff3 )
u3.encoding = 'latin1'
trainind = u3.load()

ff4 = open("/home/cvpr/jayant/scvqa/vis_img/qid2top5_vqx_val.pkl", "rb")		
u4 = pickle._Unpickler( ff4 )
u4.encoding = 'latin1'
valind = u4.load()
...
#for ques_id in tqdm(qids):
    ...
    #A = A.astype('uint8')
        ...
        for kk in range(5):
            ...
            try:
                bbox = bboxes[trainind[ques_id][kk]]
            except:
                bbox = bboxes[valind[ques_id][kk]]
