...
att_data = []
with open('/home/cvpr/jayant/scvqa/att_gv_100_train.pkl', 'rb') as fr:
    try:
        while True:
...
with open('/home/cvpr/jayant/scvqa/qid_100_train.pkl', 'rb') as f:
    qids = pickle.load(f)
...
ff1 = open("/home/cvpr/jayant/scvqa/vis_img/top5_100_train.pkl", "rb")
