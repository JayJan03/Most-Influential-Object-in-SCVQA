#find loss_hint_ind and hint_ind in train 

#print index of most influential bb
# option to print hint_ind
...
def train(model, train_loader, eval_loader, opt):
    ...
    if opt.load_hint > 1:
        if 'hatvqx' in opt.split:
            ...
            states_ = torch.load('saved_models/2022_01_22_13_24_30_166474/model-best.pth')
        else:
            states_ = torch.load('saved_models/2019_05_13_22_31_59_650582/model-best.pth')
    elif opt.load_hint > 0:
        states_ = torch.load('saved_models/2022_01_21_15_36_26_090963/model-best.pth')
    else:
