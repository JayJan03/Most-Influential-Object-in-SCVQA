...
def evaluate(model, dataloader):
    ...
    ff = open("/content/drive/MyDrive/self_critical_vqa-master/merged_cf10.pkl", "rb")					#change path
    ...
    for objs, q, a, hintscore, _, qids,imgid in tqdm(iter(dataloader)):
        ...
        loss_hint, loss_hint_ind =  torch.topk(loss_hint,5,largest=False)  # loss_hint_ind b
        ...
        print("loss_hint_ind::::::: ",loss_hint_ind)
        print(len(qids))
        print(len(hint_ind))
    ...
    pickle.dump(qid2loss, open('qid2mio_top5_nh_cp.pkl', 'wb'))
